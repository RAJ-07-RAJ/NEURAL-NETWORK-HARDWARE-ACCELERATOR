...
REM
REM Generated by Vivado on Thu Apr 23 18:13:31 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_pe_array_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_pe_array_vlog.prj -log xvlog.log
