...
REM
REM Generated by Vivado on Sun Apr 26 22:51:09 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_stagger_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_stagger_vlog.prj -log xvlog.log
